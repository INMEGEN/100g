#############################################################################################################################
## Script para agrupar (sumar) los valores en una matriz, de acuerdo al grupo al que pertenece cada fila en la matriz	#####
...
my ($inputmatrix, $idfile, $outfile, $group, $sample, $values, $line, $i);
